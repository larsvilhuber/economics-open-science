...
### Historical software usage in AEA replication packages

Data were accessed in 2025 from the Github repository at <https://github.com/AEADataEditor/aea-supplement-migration/releases/tag/v20200515>. Code was adapted for better layout.

```{r aea_migration,echo=FALSE,eval=TRUE,results='asis'}
