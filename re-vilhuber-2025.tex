% !TeX document-id = {c500552c-47fb-465a-a220-a5c65205866b}
...
\addbibresource[label=Main]{combined-references.bib}
...
\motscles{sciences ouvertes; reproductibilité; accès à resources} % Mots-clés en français
\keywords{open science; reproducibility; ressource access} % Mots-clés en anglais

\jelcode{A11; A13; B40} % Codes JEL

\begin{refsection}[Main] % Corps de texte
