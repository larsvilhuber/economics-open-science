...
\iftoggle{draft}{% Add draft watermark package
\usepackage{draftwatermark}
\SetWatermarkText{DRAFT}
\SetWatermarkScale{3}
\SetWatermarkLightness{ 0.8 }
%\SetWatermarkColor{BrickRed}
}{}
...
\maketitle
% Add disclaimer under the title
\begin{center}
\large\textit{This is a draft version for review purposes only. Please do not cite or distribute without author's permission.}
\end{center}
