...
table.aea.software_by_year <- read.csv(file=file.path(datadir,"table.aea.software_by_year.csv"))
...
ggsave(file.path(outputs,"figure_software_years_pct.png"),fig.software_by_year.pct,
